...
; (function (window) {
    ...
    gridGallery.prototype._navigate = function (dir) {
    ...
    gridGallery.prototype._closeSlideshow = function (pos) {
    ...
    gridGallery.prototype._resizeHandler = function () {
        var self = this;
        function delayed() {
            self._resize();
    ...
    gridGallery.prototype._resize = function () {
